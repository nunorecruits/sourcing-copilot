...
- Your tone sample and settings preferences
...
This data is sent directly to the AI provider's API. It is subject to that provider's privacy policy and terms of service:
...
Sourcing Copilot reads publicly visible text from LinkedIn profile pages that you navigate to while using the extension. It does not scrape, crawl or access LinkedIn data in bulk. It only processes the profile currently open in your browser tab when you explicitly trigger a score or scan action.

Use of LinkedIn data is subject to LinkedIn's User Agreement and Privacy Policy.
...
Sourcing Copilot is intended for professional use by recruiters and talent acquisition professionals. It is not directed at children under 13.
